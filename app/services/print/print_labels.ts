...
function cropMarks(): string {
  const base = `position:absolute;width:10px;height:10px;border-color:${PW.faint}`
  return `
    <span style="${base};top:-1px;left:-1px;border-top:1px solid;border-left:1px solid"></span>
    <span style="${base};top:-1px;right:-1px;border-top:1px solid;border-right:1px solid"></span>
    <span style="${base};bottom:-1px;left:-1px;border-bottom:1px solid;border-left:1px solid"></span>
    <span style="${base};bottom:-1px;right:-1px;border-bottom:1px solid;border-right:1px solid"></span>
  `
}
